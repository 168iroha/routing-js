...
describe('Router', () => {
	...
	describe('RouteTable', () => {
		...
		it('複数のルータの結合', () => {
			...
			expect(traceRoute1[0]?.route !== undefined).toBe(true);
			expect(traceRoute1[1]?.route !== undefined).toBe(true);
			...
			expect(traceRoute2[0]?.route !== undefined).toBe(true);
			...
			expect(traceRoute3[0]?.route !== undefined).toBe(true);
			expect(traceRoute3[1]?.route !== undefined).toBe(false);
